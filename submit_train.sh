...
#! Modules to load (uncomment the relevant lines):
...
python /home/ym429/project/final_project/src/inference.py --model_path /rds/user/ym429/hpc-work/dissertation/results/rescell-15step-no_loss_coef-LPIPS/checkpoint-69120 --model_type swin_unet --output_dir /rds/user/ym429/hpc-work/dissertation/inference_results/rescell-15step-no_loss_coef-LPIPS
