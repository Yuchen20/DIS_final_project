...
# from basicsr.data.tiff_dataset import OriDataset,RawDataset, \
#     OriDataset_wmask,OriDataset_3channel,OriDataset_full,OriDataset_chunling
from basicsr.data.tiff_dataset_2 import OriDataset2,OriDataset2_3channel
...
def create_dataset(dataset_config):
    if dataset_config['type'] == 'gfpgan':
        ...
        dataset = OriDataset2(dataset_config['params'])
    elif dataset_config['type'] == 'customwmask':
        dataset = OriDataset_wmask(dataset_config['params'])
    elif dataset_config['type'] == 'custom_full':
        dataset = OriDataset_full(dataset_config['params'])
    elif dataset_config['type'] == 'chunling_local':
        dataset = OriDataset_chunling(dataset_config['params'])
    elif dataset_config['type'] == 'custom_3channel':
        dataset = OriDataset2_3channel(dataset_config['params'])
